...
Static GitHub Pages hub for learning and practicing AI audit work.
...
- `assets/` - images, downloads, and future media

The site is intentionally plain HTML, CSS, and JavaScript so it works on GitHub Pages now and can migrate to a fuller publishing stack later.
